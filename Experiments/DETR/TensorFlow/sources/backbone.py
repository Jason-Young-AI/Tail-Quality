...
class ResNet101Backbone(ResNetBase):
    def __init__(self,
        ...
        self.layer3 = ResidualBlock(
            num_bottlenecks=23, dim1=256, dim2=1024, strides=2,
            replace_stride_with_dilation=replace_stride_with_dilation[1],
            name='layer3')
...
class BottleNeck(tf.keras.Model):
    def __init__(self, dim1, dim2, strides=1,
                 dilation=1, downsample=False, **kwargs):
        super().__init__(**kwargs)
        ...
        self.conv2 = Conv2D(dim1, kernel_size=3, strides=strides,
