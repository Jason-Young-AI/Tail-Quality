...
THIS_MODEL_FILENAME=detr-r101-dc5-a2e86def.h5

THIS_MODEL_NAME=DETR

THIS_FRAMEWORK=TensorFlow
...
THIS_MODEL_URL=${HF_LINK}/resolve/main/${THIS_MODEL_NAME}/${THIS_FRAMEWORK}/${THIS_MODEL_FILENAME}
